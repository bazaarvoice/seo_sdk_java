...
public class BVManagedUIContent2_Test {
  ...
  public void test_PageNumber_PRR() {
    ...
    Assert.assertTrue(
      content.contains("http://seo-stg.bazaarvoice.com/agileville-78B2EF7DE83644CAB5F8C72F2D8C8491/Main_Site-en_US/reviews/product/2/data-gen-5zkafmln4wymhcfbp5u6hmv5q.htm"),
      "URL should be valid url"
    );
    Assert.assertTrue(
      !content.contains("The resource to the URL or file is currently unavailable"),
  ...
  public void test_PageNumber_PRR_LocalFiles() {
    ...
    bvConfiguration.addProperty(
      ...
      "/Users/anandan.narayanaswam/projects/git_projects/SEO-SDK_Dev/seo_sdk_java/src/test/resources/seo_local_files/myshco-359c29d8a8cbe3822bc0d7c58cb9f9ca"
    );
    bvConfiguration.addProperty(
    ...
    Assert.assertTrue(
      content.contains("itemprop=\"review\" itemscope itemtype=\"http://schema.org/Review\""),
      "There should be atleat one review populated."
    );
    Assert.assertTrue(
      !content.contains("The resource to the URL or file is currently unavailable"),
      "resource not found or unavailable message should not be there"
  ...
  public void test_PageNumber_CONV_LocalFiles() {
    ...
    bvConfiguration.addProperty(
      BVClientConfig.LOCAL_SEO_FILE_ROOT, "/Users/anandan.narayanaswam/projects/git_projects/SEO-SDK_Dev/seo_sdk_java/src/test/resources/seo_local_files/myshco-359c29d8a8cbe3822bc0d7c58cb9f9ca"
    );
    bvConfiguration.addProperty(
      BVClientConfig.SEO_SDK_ENABLED,
      "true"
