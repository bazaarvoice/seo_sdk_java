...
public class BVParameters_Test {
  ...
  public void testEquality() {
    ...
    bvParamObj1.setBaseURI("Example-Vector.jsp");
    //this should be the current page, full URL
    bvParamObj1.setPageURI(
      "http://localhost/Example-Vector.jsp?someQuery=value1"
    );
    ...
    Assert.assertEquals(
      bvParamObj1.equals(bvParamObj2),
      false,
      "object1 and object2 should not be equal"
    );
     ...
     */
    Assert.assertEquals(
      bvParamObj1.equals(new String("AbCD")),
      false,
      "object1 and someother should not be equal"
    );

    bvParamObj2 = new BVParameters();
    bvParamObj2.setUserAgent("googlebot");
    // this value is pagination links.
    bvParamObj2.setBaseURI("Example-Vector.jsp");
    //this should be the current page, full URL.
    bvParamObj2.setPageURI(
      "http://localhost/Example-Vector.jsp?someQuery=value1"
    );
