...
public class BVSdkMessageUtilTest {
  ...
  public void testMessages() {
    ...
    assertNotNull(
      errorMessage,
      "There should be an error message in errorMessage"
    );
    ...
    assertNull(
      errorMessage,
      "There should not be an error message in errorMessage"
    );
  ...
  public void testSingletonInstance() {
    ...
    assertNull(
      theInstance,
      "theInstance object should be null since it should singleton"
    );
  }
}
