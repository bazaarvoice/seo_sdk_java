...
/**
 * Class for having seo test case related constants.
 *
 * This class will be used to define all constants that are meant to be used by
 * the test cases in seo_sdk_java. This class also simplifies by providing
 * flexibility to any change in S3 buckets.
 *
...
public class SeoTestcaseConstants {
  ...
  /**
   * Gets the test client's rootFolder that is defined in the
   * SeoTestcaseConstants.testRootFolder.
   *
