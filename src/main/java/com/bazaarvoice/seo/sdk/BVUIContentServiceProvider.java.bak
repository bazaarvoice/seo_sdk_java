...
/**
 * Implementation class for {@link BVUIContentService}.
 * This class is a self executable of Callable and Future and returns StringBuilder upon execution.
 * 
...
public class BVUIContentServiceProvider implements BVUIContentService, Callable<StringBuilder> {
	 ...
	 * If reload is true && uiContent is gretare than 0 then return from cache.
	 * @param reload
	 * @return
	 */
